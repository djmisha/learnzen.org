    ...
    handleLogoChange() {
        const changelogo =
            this.state.logoClass === "the-logo logo-normal"
                ? "the-logo logo-change"
                : "the-logo logo-normal";
        const changeTitle =
            this.state.logoTitle === "Tao Te Ching"
                ? "The Book of the Way"
                : "Tao Te Ching";
        const changeAuthor =
            this.state.logoAuthor === "Laozi" ? "Old Master" : "Laozi";
        this.setState({
    ...
    render() {
        return (
            <div
                ...
                logospin={this.props.logoSpinClass}
